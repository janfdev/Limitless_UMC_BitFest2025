...
const BlogSection = () => {
  return (
    <section className="h-[70vh] w-full relative">
      ...
      <div className="relative px-4 py-5 z-0 ">
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-2xl">Berita Kampus</h1>
          <p>Universitas CIC Cirebon</p>
        </div>
        <div className="grid md:grid-cols-2 grid-cols-1">
          <article className="rounded-lg border w-full border-gray-100 bg-white p-4 shadow-xs transition hover:shadow-lg sm:p-6 dark:border-gray-800 dark:bg-gray-900 dark:shadow-gray-700/25">
