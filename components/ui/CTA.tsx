...
export default function CTA() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl container mx-auto px-5 py-16 md:py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white">
      {/* Decorative blurs */}
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link href="/info-session">
            <Button
              size="lg"
              variant="secondary"
              className="w-full sm:w-auto bg-transparent text-white border border-white/50 hover:bg-white/10"
            >
              Jadwal Info Session
            </Button>
          </Link>
